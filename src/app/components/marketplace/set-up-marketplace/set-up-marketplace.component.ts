...
@Component({
  selector: 'app-set-up-marketplace',
  templateUrl: './set-up-marketplace.component.html',
  styleUrls: ['./set-up-marketplace.component.scss']
})

export class SetUpMarketplaceComponent implements OnInit, OnDestroy {
  step = 1;
  userId: string;
  setUpForm: FormGroup;
  otpFields: FormArray;
  ...
  ngOnInit(): void {
    this.main.updateTitle('Setup Marketplace');
  }
